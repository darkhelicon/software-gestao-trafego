...
export const organization = {
  ...
  slug: "demo-agency",
  logoUrl: null,
  website: "https://demo.helzoscale.com",
...
export const tiktokConnections = [
  {
    ...
    displayName: "Helzo Scale TikTok Business",
...
export const members = [
  ...
  },
  {
    ...
    role: "MANAGER",
    joinedAt: past(60),
    user: { id: "demo-user-2", email: "manager@helzoscale.com", name: "Ana Gerente", avatarUrl: null },
  },
  {
    userId: "demo-user-3",
    organizationId: DEMO_ORG_ID,
    role: "OPERATOR",
    joinedAt: past(30),
    user: { id: "demo-user-3", email: "operador@helzoscale.com", name: "Carlos Operador", avatarUrl: null },
  },
];
