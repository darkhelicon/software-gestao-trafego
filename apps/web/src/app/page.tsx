  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#0a0a0a]/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link href="/">
          <Image src="/helzo-scale-logo.png" alt="Helzo Scale" width={160} height={52} className="h-9 w-auto" />
        </Link>
    ...
    <footer className="border-t border-white/5 py-10 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center">
          <Image src="/helzo-scale-logo.png" alt="Helzo Scale" width={120} height={39} className="h-7 w-auto" />
        </div>
